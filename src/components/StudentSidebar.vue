<template>
  <div>
    ...
    <button 
      ...
      :class="{ 'active': isMobileVisible }"
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        <line v-if="!isMobileVisible" x1="3" y1="12" x2="21" y2="12"/>
        <line v-if="!isMobileVisible" x1="3" y1="6" x2="21" y2="6"/>
        <line v-if="!isMobileVisible" x1="3" y1="18" x2="21" y2="18"/>
    ...
    <div :class="['student-sidebar', { 'collapsed': isCollapsed, 'mobile-visible': isMobile && isMobileVisible }]">
...
@media (max-width: 768px) {
  ...
  .student-sidebar.mobile-visible {
    left: 0;
  }
  ...
  .student-sidebar.collapsed.mobile-visible {
    left: 0;
    width: 220px;
  }
